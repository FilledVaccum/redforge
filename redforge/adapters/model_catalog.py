...
MODEL_CATALOG: dict[str, ModelSpec] = dict(
    ...
    + [
        # ── HuggingFace Inference API / Hub ──────────────────────────────
        # Any model on the Hub is accessible — these are the most popular.
        # Env var: HF_TOKEN (required for gated models like Llama, Gemma)
        # Spec: huggingface/<org>/<model-name>
        #
        # Meta Llama
        _spec("huggingface", "meta-llama/Meta-Llama-3.1-405B-Instruct",
              "Llama 3.1 405B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=10,
              tags=["huggingface", "llama", "open-weights", "instruct", "gated"],
              aliases=["llama-3.1-405b", "llama3.1-405b"]),
        _spec("huggingface", "meta-llama/Meta-Llama-3.1-70B-Instruct",
              "Llama 3.1 70B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=30,
              tags=["huggingface", "llama", "open-weights", "instruct", "gated"],
              aliases=["llama-3.1-70b", "llama3.1-70b"]),
        _spec("huggingface", "meta-llama/Meta-Llama-3.1-8B-Instruct",
              "Llama 3.1 8B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "llama", "open-weights", "instruct", "fast", "gated"],
              aliases=["llama-3.1-8b", "llama3.1-8b"]),
        _spec("huggingface", "meta-llama/Llama-3.2-3B-Instruct",
              "Llama 3.2 3B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=100,
              tags=["huggingface", "llama", "open-weights", "instruct", "small", "gated"],
              aliases=["llama-3.2-3b"]),
        _spec("huggingface", "meta-llama/Llama-3.2-1B-Instruct",
              "Llama 3.2 1B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=200,
              tags=["huggingface", "llama", "open-weights", "instruct", "tiny", "fast", "gated"],
              aliases=["llama-3.2-1b"]),
        # Mistral / Mixtral
        _spec("huggingface", "mistralai/Mistral-7B-Instruct-v0.3",
              "Mistral 7B Instruct v0.3 (HF)",
              context_window=32768, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "mistral", "open-weights", "instruct"],
              aliases=["mistral-7b"]),
        _spec("huggingface", "mistralai/Mixtral-8x7B-Instruct-v0.1",
              "Mixtral 8x7B Instruct (HF)",
              context_window=32768, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=30,
              tags=["huggingface", "mistral", "open-weights", "moe", "instruct"],
              aliases=["mixtral-8x7b"]),
        _spec("huggingface", "mistralai/Mixtral-8x22B-Instruct-v0.1",
              "Mixtral 8x22B Instruct (HF)",
              context_window=65536, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=10,
              tags=["huggingface", "mistral", "open-weights", "moe", "large"],
              aliases=["mixtral-8x22b"]),
        # Google Gemma
        _spec("huggingface", "google/gemma-2-27b-it",
              "Gemma 2 27B Instruct (HF)",
              context_window=8192, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=20,
              tags=["huggingface", "google", "gemma", "open-weights", "instruct", "gated"],
              aliases=["gemma-2-27b"]),
        _spec("huggingface", "google/gemma-2-9b-it",
              "Gemma 2 9B Instruct (HF)",
              context_window=8192, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "google", "gemma", "open-weights", "instruct", "gated"],
              aliases=["gemma-2-9b"]),
        _spec("huggingface", "google/gemma-2-2b-it",
              "Gemma 2 2B Instruct (HF)",
              context_window=8192, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=200,
              tags=["huggingface", "google", "gemma", "open-weights", "small", "fast", "gated"],
              aliases=["gemma-2-2b"]),
        # Microsoft Phi
        _spec("huggingface", "microsoft/Phi-3.5-mini-instruct",
              "Phi-3.5 Mini Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=100,
              tags=["huggingface", "microsoft", "phi", "open-weights", "small", "fast"],
              aliases=["phi-3.5-mini", "phi3.5-mini"]),
        _spec("huggingface", "microsoft/Phi-3-medium-128k-instruct",
              "Phi-3 Medium 128K Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=30,
              tags=["huggingface", "microsoft", "phi", "open-weights", "instruct"],
              aliases=["phi-3-medium"]),
        # Qwen
        _spec("huggingface", "Qwen/Qwen2.5-72B-Instruct",
              "Qwen 2.5 72B Instruct (HF)",
              context_window=131072, max_output_tokens=8192,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=20,
              tags=["huggingface", "qwen", "open-weights", "instruct", "large"],
              aliases=["qwen2.5-72b"]),
        _spec("huggingface", "Qwen/Qwen2.5-7B-Instruct",
              "Qwen 2.5 7B Instruct (HF)",
              context_window=131072, max_output_tokens=8192,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=100,
              tags=["huggingface", "qwen", "open-weights", "instruct", "fast"],
              aliases=["qwen2.5-7b"]),
        _spec("huggingface", "Qwen/QwQ-32B",
              "QwQ 32B (HF) — Reasoning model",
              context_window=131072, max_output_tokens=8192,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=10,
              tags=["huggingface", "qwen", "open-weights", "reasoning"],
              aliases=["qwq-32b"]),
        # DeepSeek
        _spec("huggingface", "deepseek-ai/DeepSeek-R1",
              "DeepSeek R1 (HF) — Reasoning model",
              context_window=131072, max_output_tokens=16384,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=5,
              tags=["huggingface", "deepseek", "open-weights", "reasoning", "large"],
              aliases=["deepseek-r1-hf"]),
        _spec("huggingface", "deepseek-ai/DeepSeek-V3",
              "DeepSeek V3 (HF)",
              context_window=131072, max_output_tokens=8192,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=5,
              tags=["huggingface", "deepseek", "open-weights", "large"],
              aliases=["deepseek-v3"]),
        # Code models
        _spec("huggingface", "bigcode/starcoder2-15b",
              "StarCoder 2 15B (HF)",
              context_window=16384, max_output_tokens=4096,
              supports_system_prompt=False, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "bigcode", "open-weights", "code"],
              aliases=["starcoder2-15b"]),
        _spec("huggingface", "codellama/CodeLlama-70b-Instruct-hf",
              "Code Llama 70B Instruct (HF)",
              context_window=100000, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=10,
              tags=["huggingface", "meta", "open-weights", "code", "instruct"],
              aliases=["codellama-70b"]),
        # Community / fine-tuned chat models
        _spec("huggingface", "HuggingFaceH4/zephyr-7b-beta",
              "Zephyr 7B Beta (HF)",
              context_window=32768, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=100,
              tags=["huggingface", "open-weights", "chat", "fine-tuned"],
              aliases=["zephyr-7b"]),
        _spec("huggingface", "HuggingFaceH4/starchat2-15b-v0.1",
              "StarChat 2 15B (HF)",
              context_window=16384, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "open-weights", "chat", "code"],
              aliases=["starchat2-15b"]),
        _spec("huggingface", "CohereForAI/c4ai-command-r-plus-08-2024",
              "Command R+ 08-2024 (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=False,
              supports_function_calling=True,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=20,
              tags=["huggingface", "cohere", "open-weights", "rag", "instruct"],
              aliases=["command-r-plus-hf"]),
        _spec("huggingface", "tiiuae/falcon-40b-instruct",
              "Falcon 40B Instruct (HF)",
              context_window=8192, max_output_tokens=4096,
              supports_system_prompt=False, supports_vision=False,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=30,
              tags=["huggingface", "tii", "open-weights", "instruct"],
              aliases=["falcon-40b"]),
        # Vision-language models
        _spec("huggingface", "meta-llama/Llama-3.2-11B-Vision-Instruct",
              "Llama 3.2 11B Vision Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=True,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=30,
              tags=["huggingface", "llama", "open-weights", "vision", "instruct", "gated"],
              aliases=["llama-3.2-11b-vision"]),
        _spec("huggingface", "Qwen/Qwen2-VL-7B-Instruct",
              "Qwen2 VL 7B Instruct (HF)",
              context_window=131072, max_output_tokens=4096,
              supports_system_prompt=True, supports_vision=True,
              supports_function_calling=False,
              input_cost_per_1k=None, output_cost_per_1k=None, rate_limit_rpm=60,
              tags=["huggingface", "qwen", "open-weights", "vision", "instruct"],
              aliases=["qwen2-vl-7b"]),
    ]
)
